...
show_ma_10 = st.button("Show 10-day Moving Average")
show_ma_20 = st.button("Show 20-day Moving Average")
show_ma_50 = st.button("Show 50-day Moving Average")
show_ma_100 = st.button("Show 100-day Moving Average")
show_ma_200 = st.button("Show 200-day Moving Average")
